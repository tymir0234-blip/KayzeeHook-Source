...
namespace {
    ...
    void MessageLoop() {
        ...
        const wchar_t* cls = L"KayzeeHook_tray_class";
        ...
        HWND hwnd = CreateWindowExW(0, cls, L"KayzeeHook_tray_wnd", 0, 0, 0, 0, 0, HWND_MESSAGE, nullptr, g_hInstance, nullptr);
        ...
        lstrcpynW(nid.szTip, L"KayzeeHook", static_cast<int>(sizeof(nid.szTip) / sizeof(nid.szTip[0])));
